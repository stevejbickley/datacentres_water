...
def parse_h2_sections(soup):
    """
    Returns an OrderedDict-like structure mapping each <h2> heading
    to the combined text of paragraphs & lists that follow,
    until the next <h2> or end of container.
    """
    sections = {}
    h2s = soup.find_all("h2")
    for h2 in h2s:
